...
def main() -> int:
    ...
    required = [
        ...
        "docs/CONCURRENCY.md", "docs/DISTRIBUTED_RUNTIME.md", "docs/DISTRIBUTED_SECURITY.md", "docs/DASHBOARD.md",
        "specs/HARDWARE_CATALOG.md", "specs/EVIDENCE.md", "specs/BENCHMARKING.md", "specs/SCORING.md",
        "specs/hardware-catalog.schema.json", "specs/hardware-part.schema.json", "specs/benchmark.schema.json",
        "specs/benchmark-profile.schema.json", "specs/adapter-output.schema.json", "specs/discovery-config.schema.json",
        "specs/performance-record.schema.json", "config/discovery.example.json", "data/discovery/watchlist.json",
        "scripts/check_async_blocking.py", "scripts/check_perf_regression.py", "scripts/check_hardware_class_baseline.py",
        "scripts/run_distributed_faults.py", "benchmarks/perf-baseline.json", "benchmarks/hardware-class-baselines.json",
        "docs/BENCHMARK_HARNESS.md", "benchmarks/README.md", "results/README.md",
        ".agents/skills/hardware-research/SKILL.md", ".agents/skills/catalog-curation/SKILL.md",
        ".agents/skills/benchmark-hardware/SKILL.md", ".agents/skills/architecture-review/SKILL.md",
        ".agents/skills/release-governance/SKILL.md", ".agents/skills/accelerator-research/SKILL.md",
    ]
    for rel in required:
